...
public class NhanvienLayout extends AppCompatActivity {
    ...
    public void loadDatabase() {
        ...
        phongbanlist = convertToPhongBanList( returnListfromJSON( phongbanDB.doGet("show"), "PhongBan" ) );
...
//                        if (nhanvienDB.insert(nv) == -1) break;
                          if( !JSONHelper.verifyJSON(nhanvienDB.doPost(nv,"insert"))
...
//                        Log.d("process",JSONHelper.verifyJSON(nhanvienDB.doPost(nv,"update")));
