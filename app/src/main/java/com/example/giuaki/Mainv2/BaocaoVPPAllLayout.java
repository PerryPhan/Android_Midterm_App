...
public class BaocaoVPPAllLayout extends AppCompatActivity {
            ...
            PBSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if( nhanvienList == null || nhanvienList.size() == 0 ) {
                        ...
                        printBtn.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.disable_color)));
                        NVtoStringArray( nhanvienList );
                        setTotalMoneyView(null);
                        return;
                    }
                    printBtn.setEnabled(true);
                    printBtn.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.focus_delivered_color)));
                    setTotalMoneyView(null);
                    NVtoStringArray( nhanvienList );
                    setNVSpinnerEvent();
                }
    ...
    //        <!-- 40 / 100 / 100 / 80 / 80 -->
            List<String> list = returnListfromJSON(
