...
public class CapphatVPPLayout extends AppCompatActivity {
    ...
    //        Log.d("process", "setControl");
        ...
        public void loadDatabase(){
            ...
            capphat_list = convertToCapPhatList(
                    returnListfromJSON( capphatDB.doGet("show"),"CapPhat")
            );
            ...
            if( capphat_list == null || nhanvien_list == null || vanphongpham_list == null || phongban_list == null ){
                return;
            }
    ...
    //  ------------------------------ LAYOUT CONTROLLER  -----------------------------------
        ...
        public void createCPLayout_fromPB( String maPB ) {
            ...
            rowGenarator.enhanceRowData(
                    returnListfromJSON(
                            capphatDB.doGet("select_listVPP_withPB?mapb="+ maPB))
                    , 4 );
                ...
                row.setOnClickListener(new View.OnClickListener() {
                    ...
                    // TABLE CP INDEX 02 ----------------------------------------------------------------------------------------
                        ...
                        rowGenarator.enhanceRowData(
                            returnListfromJSON(
                                capphatDB.doGet(
                                        String.format("select_listNV_withVPP_andPB?mapb=%s&mavpp=%s"
                                                ,maPB
        ...
        public void setEventDisplayVPP( String maVPP ){
            ...
            previewVPPBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    VPP_IP_SL = dialog.findViewById(R.id.VPP_IP_Soluong);
                    ...
                    VPP_IP_SL.setText( vpp.getSoLuong().toString().trim());
    ...
    // --------------- CUSTOM HELPER --------------------------------------------------------------------
        ...
        public TableRow createRow(Context context, CapPhat cp) {
            ...
            soPhieu.setMaxWidth(DPtoPix(70));
